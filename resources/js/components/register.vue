<template>
    <div id="register" class="login-page">
        <div class="form">
            ...
            <p class="message">Već ste registrirani? <a><router-link to='/projekti/fsre_rwa/2020/g11/login' exact>Prijavite se</router-link></a></p>
        </div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        methods:{
            saveForm(){
                axios.post('/projekti/fsre_rwa/2020/g11/api/register', this.form).then(() =>{
